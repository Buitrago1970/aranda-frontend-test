...
export default function NewRecipes({recipes}: any) { 
  return (
         ...
         <div className="container-new-recipes">
            {
                ...
                <div className="recipe-info">
                    ...
                    <div className="recipe-ratings">
                        <div className="score">
                           <img src={startIcon} width={23} height={23} alt='star icon' loading="lazy" />
                            <p>5.0</p>
                        </div>
                        <div className="like">
                        <img src={likeIcon} width={23} height={23} alt='star icon' loading="lazy" />
